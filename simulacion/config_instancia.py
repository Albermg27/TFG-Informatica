...
class PerfilSimulacionInstancia:
    ...
    factor_atasco_matriz: float = 1.0
...
PERFILES_SIMULACION: dict[int, PerfilSimulacionInstancia] = {
    ...
    8: PerfilSimulacionInstancia(
        0.0032,
        "Periferia dispersa",
        "Urgentes en el anillo periférico de Madrid; viajes largos y atascos.",
